...
require_once("../includes/header/headers.php");
                    ...
                    <div class="page-header">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">All the payment can see here</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    <div class="card">
        <div class="card-body">
            <h5 class="text-muted">Friends Credit</h5>
            <div class="metric-value d-inline-block">
                <h1 class="mb-1">
                        <?php total_amount_credit(); ?>
                </h1>
            </div>
            <div class="metric-label d-inline-block float-right text-primary font-weight-bold ">
                <span ><i class="fab fa-get-pocket fa-lg ml-2 mr-3"></i></span>
            </div>
        </div>
...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    <div class="card">
        <div class="card-body">
            <h5 class="text-muted">Bank Loan</h5>
            <div class="metric-value d-inline-block">
...
<div class="card">
<h5 class="card-header">Recent Payment</h5>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <span class="legend-text">Shopping</span>
                                            </span>
                                            <span class="legend-item mr-2">
